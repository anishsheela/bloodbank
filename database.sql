...
CREATE TABLE IF NOT EXISTS `stock` (  `BID` bigint(5) NOT NULL AUTO_INCREMENT,  `BGroup` varchar(5) NOT NULL,  `Stock` int(5) NOT NULL,  PRIMARY KEY (`BID`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;
...
INSERT INTO `user` (`UserID`, `keyvalue`, `PWD`) VALUES ('admin', '5', 'cheesecake'),
